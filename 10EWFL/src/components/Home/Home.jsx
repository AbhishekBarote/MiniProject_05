      ...
      <div className="container">
        <div className="row align-items-center">
          ...
          <div className="col-md-6 mb-4">
            <p className="text-success mb-1 fw-bold fs-4">Welcome to ELocate</p>
            ...
            <p className="mt-4">
              <span className="text-success fw-bold">ELocate:</span> Transforming E-Waste Management. Find E-waste facilities effortlessly with our platform. Your key to responsible recycling and sustainability.
            </p>
            <div className="mt-4">
